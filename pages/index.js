  ...
  return (
    ...
    <Layout>
      ...
      <div className="bg-gray-50 sm:pt-2">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 p-5">

          {
            allPostsData.map(({ id, date, title})=>(

              <div key={id} class="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
